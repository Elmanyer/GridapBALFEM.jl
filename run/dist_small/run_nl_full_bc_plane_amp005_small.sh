#!/bin/bash
# SMALL run — bcplane nonlinear :full, flat bed, A=0.05 — AMPLITUDE LADDER point.
...
#SBATCH --job-name="BALFEM_nl_full_bcplane_A0.05"
...
export BALFEM_OUTDIR=$HOME/GridapBALFEM.jl/output/small_bcplane_nlfull_ampladder_A0.05_P1LFE-2
