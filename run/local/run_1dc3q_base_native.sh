...
export BALFEM_NL_PRESSURE=native   # <- THE ONE VARIED KNOB (was full)
...
export BALFEM_OUTDIR=output/local_1d/c3q_base_native
...
# BALFEM_C3_MASK not set: no Class-III blocks exist at :native, so the mask is meaningless
