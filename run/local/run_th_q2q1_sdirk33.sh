#!/bin/bash
#  TH3 - Q2/Q1, SDIRK_3_3. Separates the pairing from the temporal order.
# ==============================================================
...
export BALFEM_OUTDIR=output/local_1d/nonlinear_stability_taylor_hood/integrators/th_q2q1_sdirk33
