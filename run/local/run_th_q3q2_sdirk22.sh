#!/bin/bash
#  TH2 - Q3/Q2, SDIRK_2_2. THE VERIFIED PAIRING at the failing condition.
# ==============================================================
...
export BALFEM_OUTDIR=output/local_1d/nonlinear_stability_taylor_hood/integrators/th_q3q2_sdirk22
