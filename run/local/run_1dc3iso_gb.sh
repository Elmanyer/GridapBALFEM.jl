#!/bin/bash
# ==============================================================
#  CLASS-III TREATMENT FACTORIAL — CLASS-III ISOLATION, arm 'gb': COMPONENT 4 ONLY (the grad-b carrier, the only d2eta term)
#
...
export BALFEM_OUTDIR=output/local_1d/c3iso_gb
