...
# ==============================================================
#  EXTENDED dt LADDER — dt = 0.0001s, hand Jacobian, dx = 0.25 UNCHANGED
#
...
#  This run drives dt down by a further factor of 200x at FIXED dx, which is the
...
#  dx is held fixed.
#
#  ⚠⚠ COST. At 256,000 steps to reach T_final = 25.6 s and ~13 s/step measured at
#  this mesh, a COMPLETE run is ~924 hours of wall clock. This is NOT expected to
...
#  the ladder (2000 steps here), NOT to a step count. Otherwise this run alone
#  would write 256,000 diagnostic rows and as many VTK files.
# ==============================================================
export BALFEM_DT=0.0001
export BALFEM_SAVE_EVERY=2000
export BALFEM_DIAG_EVERY=2000
export BALFEM_PRINT_EVERY=4000
export BALFEM_USE_AD=0
export BALFEM_OUTDIR=output/local_1d/P1LFE-2_1d_bcplane_nl_full_flat_Q2Q1-nx240_A0.1_T1.6_dt0.0001_hand
