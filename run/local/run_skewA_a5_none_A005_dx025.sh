#!/bin/bash
#  A5 — nl_none, A=0.05, dx=0.25, SKEW ON. The one baseline that survived: does its 0.0512→0.0821 drift flatten?
# ==============================================================
...
export BALFEM_OUTDIR=output/local_1d/skewA5_none_A005_dx025
