#!/bin/bash
#  ==== 2026-09-23 TEST A: identical to run_1dc3q_base_mixed.sh (aux in Q3, died t=16.0 s)
#  except the AUXILIARY SPACE ORDER: BALFEM_P_AUX=2 (the eta order). NEW_TREATMENT.md F.3.2 ====
# ==============================================================
...
export BALFEM_OUTDIR=output/local_1d/c3q_base_mixed_aux2
...
export BALFEM_P_AUX=2          # <- THE ONE VARIED KNOB (aux was Q3 = velocity order)
...
# ---- Q3/Q2 batch, configuration 'base' ----------------------------------------
