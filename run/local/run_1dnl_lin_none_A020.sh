#!/bin/bash
# 1-D NONLINEAR INSTABILITY STUDY -- lin_none, A=0.2
#   linear control -- CANNOT produce a modulational instability at any amplitude; if it grows, the cause is not BF
#
...
#      A=0.15  53.6%                         6.3 s
#      A=0.20  71.5%                         3.6 s
#  This case is A=0.2 (71.5% of Miche, e-folding 3.6 s).
