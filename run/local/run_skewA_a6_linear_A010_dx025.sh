#!/bin/bash
#  A6 — LINEAR, A=0.10, SKEW ON. The correction must be INERT here (it lives in the advection block); the driver warns.
# ==============================================================
...
export BALFEM_OUTDIR=output/local_1d/skewA6_linear_A010_dx025
