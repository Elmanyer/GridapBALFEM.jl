...
# ==============================================================
#  BAR SHOULDER LADDER — this run: shoulder = 1.0 m, max|grad h| = 1.0 (45 deg)
#
...
#
#  max|grad h| = hbar / (2*sramp), so this run sits at 1.0 (45 deg).
#
...
# ==============================================================
export BALFEM_SBAR=1.0
export BALFEM_OUTDIR=output/local_1d/P1LFE-2_1d_bcplane_nl_native_bar_Q2Q1-nx240_A0.1_T1.6_shoulder1.0
