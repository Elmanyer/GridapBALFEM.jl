#!/bin/bash
#  ==== 2026-09-23 RK4 INTEGRATOR TEST (projected :full) — Q2/Q1, EXPLICIT RK4 (control: the reference itself, 40.40 s) ====
...
export BALFEM_OUTDIR=output/local_1d/c3r_q2q1_proj_rk4
