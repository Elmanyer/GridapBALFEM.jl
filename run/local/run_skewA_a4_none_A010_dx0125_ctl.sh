#!/bin/bash
#  A4 — A3 with SKEW OFF: the in-harness null control (rule 38c). Must reproduce the baseline failure.
# ==============================================================
...
export BALFEM_SKEW=0
export BALFEM_NX=480
export BALFEM_AWAVE=0.1
export BALFEM_OUTDIR=output/local_1d/skewA4_none_A010_dx0125_ctl
