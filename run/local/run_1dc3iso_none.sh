#!/bin/bash
# ==============================================================
#  CLASS-III TREATMENT FACTORIAL — CLASS-III ISOLATION, arm 'none': CLASS-III SUPPRESSED ({3,6,7,8} still assembled -- NOT :native)
#
...
export BALFEM_OUTDIR=output/local_1d/c3iso_none
