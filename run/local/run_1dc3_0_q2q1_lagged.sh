#!/bin/bash
# ==============================================================
#  CLASS-III TREATMENT FACTORIAL — run #0: CONTROL — Q2/Q1 lagged, must reproduce the known t = 12.60 s onset
#
...
export BALFEM_OUTDIR=output/local_1d/c3_0_Q2Q1_lagged
