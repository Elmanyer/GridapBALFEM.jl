#!/bin/bash
#  ==== 2026-09-23 RK4 INTEGRATOR TEST (projected :full) — Q3/Q2, EXPLICIT RK4 (control: run_1dc3r_q3q2_proj_sdirk.sh) ====
...
export BALFEM_OUTDIR=output/local_1d/c3r_q3q2_proj_rk4
