#!/bin/bash
#  TH4 - Q3/Q2, SDIRK_3_3. Highest-fidelity combination in the matrix.
# ==============================================================
...
export BALFEM_TABLEAU=SDIRK_3_3
export BALFEM_OUTDIR=output/local_1d/nonlinear_stability_taylor_hood/integrators/th_q3q2_sdirk33
